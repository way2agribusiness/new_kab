...
const AddFPOAdmin = ({ user, selectedComponent, setSelectedComponent }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        cropDetails: [{ cropname: "", quantity: null, pricerange: "", remarks: "" }],
        productDetails: [{ productname: "", quantity: null, value: "", remarks: "" }],

        sellerID: selectedComponent && selectedComponent.data.sellerID || user._id
    });
    ...
    useEffect(() => {
        ...
        if (selectedComponent && selectedComponent.data) {
            setFormData(prevData => ({
                ...
                sellerID: selectedComponent.data.sellerID || user._id
            }));
        ...
        <>
            <div className="flex flex-col mb-5">
                <h4 className="text-gray-800 text-center font-semibold">
                    {selectedComponent && selectedComponent.data ? 'Update FPO Content' : 'Add New FPO'}
                </h4>
                <div
            ...
            dark:shadow-none">
                  ...
                  dark:focus:border-success`}
                        ...
                        <div className="text-center">
                            ...
                            >
                                {selectedComponent && selectedComponent.data ? 'Update' : 'Submit'}
                            </button>
                        </div>
                    </form>
                </div>
