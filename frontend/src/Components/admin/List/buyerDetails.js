        ...
        >
            ...
            <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                ...
                <div className="relative z-30 mx-auto -mt-8 sm:-mt-22 h-16 w-full max-w-16 rounded-full p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
                    <div className="relative drop-shadow-2">
                        {buyerdetails && buyerdetails.photo ? (
                            <img
                                src={buyerdetails.photo}
                                alt="profile"
                            ...
                            <div className="bg-green-300 w-16 h-16 sm:w-full sm:h-28 md:h-36  flex items-center justify-center bg-gray-300 rounded-full text-lg font-semibold text-white">
                                {`${buyerdetails && buyerdetails.username.charAt(0) || ''}${buyerdetails && buyerdetails.username.split(' ')[1]?.charAt(0) || ''}`}
                            </div>
                        )}
                    </div>
                </div>
                <div className="mt-4">
                    ...
                    <p className="font-medium">{buyerdetails.roleID.name}</p>
                    ...
                    <div className="mx-auto max-w-180">
                        ...
                        <p className="mt-4.5">
                            {buyerdetails.addressID
                                ? `${buyerdetails.addressID.address_line1}, ${buyerdetails.addressID.address_line2},
                                 ${buyerdetails.addressID.city}, ${buyerdetails.addressID.state},
                                  ${buyerdetails.addressID.postal_code}, ${buyerdetails.addressID.country}`
